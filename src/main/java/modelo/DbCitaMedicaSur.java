...
public class DbCitaMedicaSur extends Conexion{
    ...
    public boolean guardar (CitaMedicaSur cms){
        ...
        String sql= "INSERT INTO CitaMedica_Sur (codigo_cita,comentario,"
    ...
    public boolean modificar (CitaMedicaSur cms){
        PreparedStatement ps; 
        Connection con= getConexion();
        String sql= "UPDATE CitaMedica_Sur SET comentario= ?,"
    ...
    public boolean eliminar (CitaMedicaSur cms){
        PreparedStatement ps; 
        Connection con= getConexion();
        String sql= "DELETE FROM CitaMedica_Sur WHERE codigo_cita= ?";
        try {
            ps = con.prepareStatement(sql);
            ps.setInt(1, cms.getCodigoCita());
            ps.execute();
    ...
    public boolean buscar (CitaMedicaSur cms){
        ...
        ResultSet rs;
        Connection con= getConexion();
        String sql= "SELECT * FROM CitaMedica_Sur WHERE codigo_cita= ?";
        try {
            ps = con.prepareStatement(sql);
            ps.setInt(1, cms.getCodigoCita());
            rs= ps.executeQuery();
